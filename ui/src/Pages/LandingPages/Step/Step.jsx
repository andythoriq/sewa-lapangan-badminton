                  ...
                  <Form onSubmit={handleSendOTP} style={{ width: "120%" }}>
                    <Form.Group className="mb-2 mt-3">
                      ...
                      <PhoneInput
                        ...
                        specialLabel={""}
                        country={"id"}
                        value={phoneNumber.substring(0, 1) === "0" ? "62" + phoneNumber.slice(1) : phoneNumber}
                        onChange={(phone) => {
                    ...
                    <Form.Group className="mb-2">
                      {errors.name && (
                        <>
                          ...
                          <span className={errors.name[0] === "Please enter your name." ? "text-danger" : "text-danger"}>{errors.name[0]}</span>
                        </>
                      )}
                    </Form.Group>

        ...
        <Form encType="multipart/form-data">
          <Row>
            <Col className="col-12 col-md-6">
              <Form.Group>
                <FormInput type="text" name="label" label="Name" value={values.label} onChange={onChange} />
                {errors.label && <span className="text-danger">{errors.label[0]}</span>}
              </Form.Group>
            </Col>
            <Col className="col-12 col-md-6 mask-input-price">
              <Form.Group>
                {/* {/* <NumberInput placeholder="Rp" type="text" /> */ }
                <label>Price</label>
                <MaskedInput 
                    mask={currencyMask}
